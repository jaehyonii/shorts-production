...
출력 형식 준수: 아래 [출력 형식]을 반드시 지켜서 결과물을 생성해. 다른 설명이나 Markdown 형식 없이, 순수한 JSON 텍스트만 출력해.
